    ...
    'app' => [
        ...
        'elements' => [
            [
                ...
                'value' => 'First Kick', // default value if you want
            ],
            [
                'type' => 'text', // input fields type
                ...
                'class' => '', // any class for input
                'value' => 'First Kick is a CMS like modular starter application project built with Laravel. This starter project can be used as a foundation to build your own projects.', // default value if you want
            ],
            [
                'type' => 'text', // input fields type
                'data' => 'string', // data type, string, int, boolean
    ...
    'social' => [
        ...
        'elements' => [
            ...
            [
                ...
                'rules' => 'nullable|max:191', // validation rule of laravel
                'class' => '', // any class for input
                'value' => 'https://twitter.com/leeibrah', // default value if you want
            ],
            [
                'type' => 'text', // input fields type
                'data' => 'string', // data type, string, int, boolean
                ...
                'rules' => 'nullable|max:191', // validation rule of laravel
                'class' => '', // any class for input
                'value' => 'https://www.instagram.com/leeibrah', // default value if you want
            ],
            [
                'type' => 'text', // input fields type
                'data' => 'string', // data type, string, int, boolean
    ...
    'meta' => [
        ...
        'elements' => [
            [
                ...
                'rules' => 'required', // validation rule of laravel
                'class' => '', // any class for input
                'value' => 'First Kick | An Awesome First Kick Project', // default value if you want
            ],
            [
                'type' => 'text', // input fields type
                'data' => 'text', // data type, string, int, boolean
                ...
                'rules' => 'required', // validation rule of laravel
                'class' => '', // any class for input
                'value' => 'Copyright 2025. Bright Studios. All rights reserved. ', // default value if you want
            ],
            [
                'type' => 'text', // input fields type
                'data' => 'text', // data type, string, int, boolean
                ...
                'rules' => 'nullable', // validation rule of laravel
                'class' => '', // any class for input
                'value' => 'Web Application, web app, Laravel, First Kick, Bootstrap, Admin, Template, Open Source, nasir khan saikat, leeibrah', // default value if you want
            ],
            [
                'type' => 'text', // input fields type
                'data' => 'text', // data type, string, int, boolean
            ...
            [
                ...
                'rules' => 'nullable', // validation rule of laravel
                'class' => '', // any class for input
                'value' => '@leeibrah', // default value if you want
            ],
            [
                'type' => 'text', // input fields type
                'data' => 'text', // data type, string, int, boolean
