                ...
                <div class="col-xl-12">
                    <div class="tp-project__details-wrapper">
                        <div class="tp-project__details-thumb mb-55">
                            <img class="w-100" src="/assets/img/service/interior-banner.png" alt="">
                        </div>
                    </div>
                </div>
                <div class="col-xl-8 col-lg-8">
                    <div class="tp-project__details-content-box">
                        <div class="tp-project__details-content mb-65">
                            ...
                            <p>
                                Industrial and commercial signage is a very diverse area and the needs of industrial premises for adequate signage from exterior frontage panels and branding is great, with wayfinding internals featuring your brand through to shop floor health and safety signs we believe Sign & Print can solve every need whatever your project. 
                                <br/><br/>
                                Please see our Case Study for more details of our service.
                            </p>
                        </div>
                            ...
                            <div class="swiper-container tp-project__details-active">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="tp-project__item">
                                            <div class="tp-project__thumb p-relative">
                                                <img class="w-100" src="/assets/img/service/interior-01.png" alt="">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="tp-project__item">
                                            <div class="tp-project__thumb p-relative">
                                                <img class="w-100" src="/assets/img/service/interior-02.png" alt="">
                                                <div class="tp-project__shape">
                                                    <img  src="/assets/img/team/shape-1-1.png" alt="">
                                                </div>
                                            </div>
