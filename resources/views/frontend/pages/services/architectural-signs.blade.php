                ...
                <div class="col-xl-12">
                    <div class="tp-project__details-wrapper">
                        <div class="tp-project__details-thumb mb-55">
                            <img class="w-100" src="/assets/img/service/architectural-banner.png" alt="">
                        </div>
                    </div>
                </div>
                <div class="col-xl-8 col-lg-8">
                    <div class="tp-project__details-content-box">
                        <div class="tp-project__details-content mb-65">
                            ...
                            <p>
                                Architectural signage products for architects and designers, we work with you from concept advising on the materials, production and installation schedules, we offer the full range of products from internals door signs and wayfinding solutions to external monoliths and building idents. 
                                <br/><br/>
                                We would be delighted to help you with your project and provide you with the best solution to suit your organisations corporate identity and budget.
                            </p>
                        </div>
                            ...
                            <div class="swiper-container tp-project__details-active">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="tp-project__item">
                                            <div class="tp-project__thumb p-relative">
                                                <img class="w-100" src="/assets/img/service/architectural-01.png" alt="">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="tp-project__item">
                                            <div class="tp-project__thumb p-relative">
                                                <img class="w-100" src="/assets/img/service/architectural-02.png" alt="">
                                                <div class="tp-project__shape">
                                                    <img  src="/assets/img/team/shape-1-1.png" alt="">
                                                </div>
                                            </div>
