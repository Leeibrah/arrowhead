                ...
                <div class="col-xl-12">
                    <div class="tp-project__details-wrapper">
                        <div class="tp-project__details-thumb mb-55">
                            <img class="w-100" src="/assets/img/service/pos-banner.png" alt="">
                        </div>
                    </div>
                </div>
                <div class="col-xl-8 col-lg-8">
                    <div class="tp-project__details-content-box">
                        <div class="tp-project__details-content mb-65">
                            ...
                            <p>
                                Somewhere between 30% and 80% of our purchasing decisions are made at the point of sale. Procter & Gamble, the consumer goods giant behind Pampers nappies and Gillette razors, calls it “the first moment of truth” for a brand. We can help you promote your brand and products to your customers through posters, information dispensers, roll up banners, exterior banners, pavement signage products, exterior display units, illuminated exterior displays. 
                                <br/><br/>
                                There are limitless possibilities for promoting your brand and products to your customers – if you’re just setting up and would like the whole package or would just like some on counter POS solution we can help.
                            </p>
                        </div>
                            ...
                            <div class="swiper-container tp-project__details-active">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="tp-project__item">
                                            <div class="tp-project__thumb p-relative">
                                                <img class="w-100" src="/assets/img/service/pos-01.png" alt="">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="tp-project__item">
                                            <div class="tp-project__thumb p-relative">
                                                <img class="w-100" src="/assets/img/service/pos-02.png" alt="">
                                                <div class="tp-project__shape">
                                                    <img  src="/assets/img/team/shape-1-1.png" alt="">
                                                </div>
                                            </div>
