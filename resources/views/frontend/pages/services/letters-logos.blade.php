                ...
                <div class="col-xl-12">
                    <div class="tp-project__details-wrapper">
                        <div class="tp-project__details-thumb mb-55">
                            <img class="w-100" src="/assets/img/service/logo-banner.png" alt="">
                        </div>
                    </div>
                </div>
                <div class="col-xl-8 col-lg-8">
                    <div class="tp-project__details-content-box">
                        <div class="tp-project__details-content mb-65">
                            ...
                            <p>
                                Amazing tactile and an eyecatcher for any business reception wall, whether it be for your office wall or a building ident our 20 years of experience and products knowledge lets us pick the right product for you.
                            </p>
                        </div>
                            ...
                            <div class="swiper-container tp-project__details-active">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="tp-project__item">
                                            <div class="tp-project__thumb p-relative">
                                                <img class="w-100" src="/assets/img/service/logo-01.png" alt="">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="tp-project__item">
                                            <div class="tp-project__thumb p-relative">
                                                <img class="w-100" src="/assets/img/service/logo-02.png" alt="">
                                                <div class="tp-project__shape">
                                                    <img  src="/assets/img/team/shape-1-1.png" alt="">
                                                </div>
                                            </div>
